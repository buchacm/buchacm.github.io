...
- Separated variables on plane algebraic curves
  ...
  joint meeting of the ÖMG and DMV, Linz, Austria, 2025
  ...
  Arbeitsgemeinschaft Diskrete Methematik, Universität Wien, Vienna, Austria, 2025

- Separating variables in bivariate polynomial ideals: the local case

  <a href="https://github.com/buchacm/slides/blob/main/admont2023separatingVariablesUpdate.pdf" target="_blank" rel="noopener"> [slides] </a> SFB status seminar, Admont, Austria, 2023
...
- x(1-t(x+x^{-1})F(x;t) = x - tF(0;t)
  ...
  <a href="https://github.com/buchacm/slides/blob/main/ricamIntro.pdf" target="_blank" rel="noopener"> [slides] </a> Symbolic computation seminar, RICAM ÖAW, Linz, Austria, 2023
...
- Quadrant walks starting outside the quadrant
  ...
  FPSAC 2021, Bar Ilan University, Ramat Gan, Israel, Online, 2022
...
- Algorithms for the enumeration of lattice walks
  ...
  <a href="https://github.com/buchacm/slides/blob/main/rigorosumBuchacher.pdf" target="_blank" rel="noopener"> [slides] </a> PhD defence, JKU Linz, Linz, Austria, 2021

- Separating variables in bivariate polynomial ideals

  <a href="https://github.com/buchacm/slides/blob/main/strobl2021.pdf" target="_blank" rel="noopener"> [slides] </a> Séminaire de Calcul Formel, Sorbonne Université, Paris, and INRIA Saclay, Palaiseau, France, Online, 2021
...
- Inhomogeneous lattice walks
  ...
  SIAM AG 2019, Bern, Switzerland, 2019

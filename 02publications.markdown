...
These articles discuss problems of finding polynomials / rational functions whose variables are separated. The first explains how to determine 
{::nomarkdown}  
$I \cap \left(\mathbb{C}[x] + \mathbb{C}[y]\right)$
{:/}  
...
These problems, and the question how the semi-algorithms for their treatment can be turned into algorithms, are intimately connected to problems in dynamical systems of algebraic correspondences. This connection, and some of its ascpects, are discussed in these notes.   
...
This generalization relies on a thorough understanding of the Newton-Puiseux algorithm. This paper discusses, among other things, how it allows one to encode algebraic series and derive information about the convex hull of their support.
